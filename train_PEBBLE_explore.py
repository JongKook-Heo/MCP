...
from utils.replay_buffer_explore import ReplayBufferExplore
from utils.logger import Logger
import hydra
from reward_model.explore_reward_model import RewardModelExplore
...
class Workspace:
    def __init__(self, cfg):
        ...
        self.replay_buffer = ReplayBufferExplore(self.env.observation_space.shape,
        ...
        self.reward_model = RewardModelExplore(self.env.observation_space.shape[0],
...
@hydra.main(config_path='config', config_name='train_PEBBLE_explore', strict=True)
def main(cfg):
