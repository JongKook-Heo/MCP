...
import hydra
from reward_model.vanilla_reward_model_mixup import RewardModelMixup
...
class Workspace:
    def __init__(self, cfg):
        ...
        self.reward_model = RewardModelMixup(self.env.observation_space.shape[0],
...
@hydra.main(config_path='config', config_name='train_PEBBLE_mixup_ablation', strict=True)
def main(cfg):
