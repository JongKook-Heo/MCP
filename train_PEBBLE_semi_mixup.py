...
import hydra
from reward_model.semi_reward_model_mixup import RewardModelSemiDataAugMixup
...
class Workspace:
    def __init__(self, cfg):
        ...
        self.reward_model = RewardModelSemiDataAugMixup(self.env.observation_space.shape[0],
    ...
    def learn_reward(self, first_flag=0):
        ...
        if self.labeled_feedback > 0:
            ...
            total_acc = self.reward_model.semi_train_reward_mixup(num_iters, self.cfg.original_concat)
...
@hydra.main(config_path='config', config_name='train_PEBBLE_semi_mixup', strict=True)
def main(cfg):
