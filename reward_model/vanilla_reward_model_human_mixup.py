...
class RewardModelHumanMixup(RewardModelHuman):
    def __init__(self, obs_dim, action_dim,
                 ...
                 teacher_eps_skip=0, teacher_eps_equal=0, video_record_path='pebble_videos', mixup_alpha=0.1, seed=12345):
        
        super(RewardModelHumanMixup, self).__init__(obs_dim, action_dim, ensemble_size, lr, mb_size, size_segment, max_size,
                                        activation, capacity, large_batch, label_margin, teacher_beta, teacher_gamma,
                                        teacher_eps_mistake, teacher_eps_skip, teacher_eps_equal, video_record_path, seed)                
