...
import hydra
from reward_model.MRN_reward_model import RewardModelMRN
from collections import deque
import pickle as pkl
import warnings
from utils.utils import MetaOptim
...
class Workspace:
    def __init__(self, cfg):
        ...
        self.reward_model = RewardModelMRN(self.env.observation_space.shape[0],
...
@hydra.main(config_path='config', config_name='train_MRN', strict=True)
def main(cfg):
